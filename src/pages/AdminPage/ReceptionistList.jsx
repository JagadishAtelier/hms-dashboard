...
function ReceptionistList() {
  ...
  return (
    <motion.div
      ...
      className="p-0 sm:p-4 w-full max-w-full mx-auto h-full flex flex-col"
    >
      {/* Header */}
        ...
        {displayData.map((item) => (
          <div key={item.id} className="w-full bg-white border border-gray-200 rounded-lg p-3 shadow-sm">
            ...
            <div className="flex justify-between mb-2">
              ...
              <span className={`text-xs px-2 py-1 rounded ${item.is_active ? "bg-green-100 text-green-700" : "bg-red-100 text-red-600"
                }`}>
                {item.is_active ? "Active" : "Inactive"}
              </span>
            </div>
